...
vim.keymap.set('n', '<leader>tc', '<cmd>set spell!<cr>', { desc = 'Toggle Spell [C]heck' })
...

  {
    ...
    config = function()
        ...
        content = {
          active = function()
            ...
            if filetype ~= '' then
              if vim.g.have_nerd_font then
                ...
                if has_mini_icons then
                  ...
                  filetype_str = string.format('%s %s', icon, filetype)
                else
            ...
            return statusline.combine_groups {
              ...
              '%=',
              { hl = 'ministatuslinefileinfo', strings = { filetype_str, encoding } },
      ...
      statusline.section_git = function(args)
        ...
        local icon = args.icon or (vim.g.have_nerd_font and '\u{e0a0}' or 'git')
